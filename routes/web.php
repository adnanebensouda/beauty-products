...
Route::get('/mylogin' , [ProductsController::class , 'admin_two']);
Route::get('/mylogin/stats' , [ProductsController::class , 'stats']);
Route::get('/mylogin/add_product' , [ProductsController::class , 'add']);
Route::post('/add_product' , [ProductsController::class , 'add_item']);
Route::get('/reservation/delete/{id}' , [ProductsController::class , 'delete_reservation']);
Route::get('products/delete/{id}' , [ProductsController::class , 'delete_product']);
